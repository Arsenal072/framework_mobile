 ...
 * @Last Modified time: 2020-04-29 16:47:43
 */
<!--  -->
<template>
    <div class='wrapper'>
        <div id='pdf'></div>
        <!-- <a target="_blank" href="../../static/pdf/web/viewer.html?file=02.pdf">在线预览PDF文件</a> -->
    </div>
</template>

<script>
import Pdfh5 from "../../static/pdfh5-master/js/pdfh5";
export default {
    name: "DrugInquiry",
    components: {},
    ...
    mounted() {
        var pdfh5 = new Pdfh5("#pdf", {
            pdfurl: "https://arxiv.org/pdf/1605.02688.pdf"
        });
    }
};
</script>
